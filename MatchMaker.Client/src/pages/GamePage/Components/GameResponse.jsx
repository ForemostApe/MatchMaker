...
const GameResponse = ({ game }) => {
  ...
  const isCoach = user.userRole === "Coach" && user.teamAffiliation === game.awayTeamId == "Planned";
  const isReferee = user.userRole === "Referee" && user.userId === game.refereeId && game.gameStatus == "Signed";
